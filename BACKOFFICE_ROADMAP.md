...
- **Решено пользователем, строится/спланировано**: Admin users (экран 33) — LDAP не нужен, полноценный локальный логин/пароль — см. раздел "Admin users" ниже. TPS-дашборд (экран 29) — подтверждён "сразу полная версия", фазовый план ниже. ~~Chat (экран 27)~~ ✅ готово, обе стороны — см. раздел "Chat" ниже. A2P/P2A/DLRs per-PDU (экраны 38-40) — подтверждены нужными, в очереди отдельным заходом.
