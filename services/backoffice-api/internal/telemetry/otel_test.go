...
func TestMiddlewareRecordsSpanWithAttributes(t *testing.T) {
	...
	mw := Middleware(tp, func(r *http.Request) string { return "/v1/dlq" })
	req := httptest.NewRequest(http.MethodGet, "/v1/dlq?stage_name=BILLING", nil)
