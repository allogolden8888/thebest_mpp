...
// внешних зависимостей (PostgreSQL/Kafka).
...
// трафик от readiness probe, даже если Postgres/Kafka давно недоступны.
...
func Router(state *State) *http.ServeMux {
	...
	mux.HandleFunc("/metrics", func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
		_, _ = w.Write([]byte("# HELP config_event_publisher_up Service liveness placeholder\n# TYPE config_event_publisher_up gauge\nconfig_event_publisher_up 1\n"))
	})
