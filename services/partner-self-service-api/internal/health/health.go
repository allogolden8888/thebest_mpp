...
// та же конвенция, что во всех остальных Go-сервисах этой сессии.
package health
...
func Router(state *State) *http.ServeMux {
	...
	mux.HandleFunc("/metrics", func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
		_, _ = w.Write([]byte("# HELP partner_self_service_api_up Service liveness placeholder\n# TYPE partner_self_service_api_up gauge\npartner_self_service_api_up 1\n"))
	})
