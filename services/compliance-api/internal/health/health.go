...
// остальных Go сервисах этой сессии (см. services/backoffice-api/internal/health).
package health
...
func Router(state *State) *http.ServeMux {
	...
	mux.HandleFunc("/metrics", func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
		_, _ = w.Write([]byte("# HELP compliance_api_up Service liveness placeholder\n# TYPE compliance_api_up gauge\ncompliance_api_up 1\n"))
	})
